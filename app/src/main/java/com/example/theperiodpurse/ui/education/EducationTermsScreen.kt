...
fun EducationTermsScreen() {
    ...
    Column(
        ...
        Body("These terms and conditions (the \"Terms and Conditions\") govern the use " +
        ...
        Body("All content published and made available on our Site is the property of The " +
        ...
        Body("When you create an account on our Site, you agree to the following:  \n" +
        ...
        Body("The Period Purse and our directors, officers, agents, employees, " +
        ...
        Body("Except where prohibited by law, by using this Site you indemnify and " +
        ...
        Body("These Terms and Conditions are governed by the laws of Canada. " +
                "The Period Purse headquarters is in Ontario. ")


        Header("Severability")

        Body("If at any time any of the provisions set forth in these Terms and Conditions " +
        ...
        Body("These Terms and Conditions may be amended from time to time in order to " +
        ...
        Body("Please contact us if you have any questions or concerns. " +
                "Our contact details are as follows:\n\n")

        Body("hello@theperiodpurse.com \n\n" +
