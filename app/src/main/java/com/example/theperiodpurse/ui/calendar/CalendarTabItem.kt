...
typealias ComposableNavFun = @Composable (calendarUIState: CalendarUIState, navController: NavController) -> Unit
...
open class CalendarTabItem(var title: String, var screen: ComposableNavFun) {
    ...
    object CalendarTab : CalendarTabItem(
        "Calendar",
        {calendarUIState, navController -> CalendarScreenLayout(calendarUIState, navController) })
